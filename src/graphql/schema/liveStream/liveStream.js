...
const uploadBulkLiveStream = require('./resolvers/uploadBulkLiveStream');
...
const schema = gql`
  ...
  type LiveStreamUpdateError {
    id: String!
    errors: [String]!
  }
  
  type LiveStreamBulkUpdated {
    total: Int!
    success: [LiveStream]
    failure: Int
    upload: Int
    errors: [LiveStreamUpdateError]
  }
  extend type Query {
  ...
  extend type Mutation {
    ...
    uploadBulkLiveStream(fileName:String!, bucket:String): LiveStreamBulkUpdated! @auth(requires: USER)
  }
