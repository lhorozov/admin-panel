...
const uploadProductCategoryCSV = require('./resolvers/uploadProductCategoryCSV');
const resizeProductCategoryImages = require('./resolvers/resizeProductCategoryImages');
...
const schema = gql`
  ...
  type ProductCategoryUploaded {
    total: Int!
    success: Int!
    failed: Int!
    failedList: UploadErrorList!
  }
  ...
  extend type Mutation {
    ...
    """
      Allows: authorized administrator
    """
    uploadProductCategoryCSV(file: Upload!, batch: Int = 100 ): ProductCategoryUploaded! @auth(requires: ADMIN)

    """
      Allows: authorized administrator
    """
    resizeProductCategoryImages(data: ResizeImageInput!): ImageResized @auth(requires: ADMIN)
...
module.exports.resolvers = {
  ...
  Mutation: {
    ...
    uploadProductCategoryCSV,
    resizeProductCategoryImages,
