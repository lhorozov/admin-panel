                        ...
                        <table class="no_float" align="left" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="editable-img" align="center">
                                    <a href="#">
                                        <img editable="true" class="centerize" mc:edit="image101" src="${cdn.appAssets}/images/app-logo.png" style="display:block; line-height:0; height: 40px; font-size:0; border:0;" border="0" alt="image" />
                                    </a>
                                </td>
                            </tr>
                            <!-- margin-bottom -->
