...
module.exports = {
  ...
  awsSMTP: {
    ...
    from: 'Shoclef <Onboard@shoclef.com>',
    fromOther: 'Shoclef <Info@shoclef.com>',
  },
  shoclefCompany: {
    seller: {
      name: 'Shoclef Inc',
  ...
  streaming: {
    wsurl: process.env.STREAM_WS_URL,
    fileurl: process.env.STREAM_FILE_URL,
    abs_url: process.env.STREAM_ABS_URL,
  },
  internal: {
